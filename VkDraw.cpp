...
bool VkDraw::QueueFamilyIndices::isComplete()
{
...
bool VkDraw::checkDeviceExtensionSupport(VkPhysicalDevice device)
{
...
// TODO: extract to a common utility file
...
int VkDraw::rateDeviceSuitability(VkPhysicalDevice device)
{
...
VkDraw::QueueFamilyIndices VkDraw::findQueueFamilies(VkPhysicalDevice device)
{
...
VkDraw::SwapChainSupportDetails VkDraw::querySwapChainSupport(VkPhysicalDevice device)
{
...
VkSurfaceFormatKHR VkDraw::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR VkDraw::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D VkDraw::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
bool VkDraw::isDeviceSuitable(VkPhysicalDevice device)
{
	VkPhysicalDeviceProperties deviceProperties;
	VkPhysicalDeviceFeatures deviceFeatures;
	vkGetPhysicalDeviceProperties(device, &deviceProperties);
...
void VkDraw::pickPhysicalDevice()
{
...
void VkDraw::createLogicalDevice()
{
	QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
...
void VkDraw::createGraphicsPipeline()
{
	...
	// no need due to hardcoded vertex info in vertex shader
